...
import { Terminal, Activity, Cpu, Globe, X, Twitter, Linkedin, Github } from 'lucide-react';
...
const PatternCyber: React.FC<Props> = ({ content }) => {
    ...
    return (
        <div className="min-h-screen bg-cyber-black text-cyber-green font-mono relative overflow-x-hidden selection:bg-cyber-green selection:text-black">
            ...
            {/* Exit Button - using Link for navigation */}
            <Link
                href="/"
            ...
            >
                <span className="text-xs tracking-widest">[ システム終了 ]</span>
                <X size={14} />
            </Link>
                ...
                <section className="w-full border-t border-cyber-green/30 bg-black py-12">
                    <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
                        ...
                        <div className="text-right">
                            <div className="text-xs text-cyber-cyan animate-pulse">アップリンク確立</div>
