                ...
                <div className="space-y-6">
                    ...
                    <div className="border border-gray-200 rounded-xl overflow-hidden">
                        <div className="bg-gray-50 p-6 flex items-start gap-4">
                            ...
                            <h3 className="text-gray-900 font-bold text-lg pt-0.5">初心者でも大丈夫ですか？</h3>
                        </div>
                    ...
                    <div className="border border-gray-200 rounded-xl overflow-hidden">
                        <div className="bg-gray-50 p-6 flex items-start gap-4">
                            <span className="text-impact-red font-bold font-mono text-xl">Q.</span>
                            <h3 className="text-gray-900 font-bold text-lg pt-0.5">特別なアプリや機材は必要ですか？</h3>
                        </div>
                        <div className="p-6 pt-0 bg-gray-50 text-gray-600 leading-relaxed pl-14">
                    ...
                    <div className="border border-gray-200 rounded-xl overflow-hidden">
                        <div className="bg-gray-50 p-6 flex items-start gap-4">
                            <span className="text-impact-red font-bold font-mono text-xl">Q.</span>
                            <h3 className="text-gray-900 font-bold text-lg pt-0.5">定期的に通わないと意味がないですか？</h3>
                        </div>
                        <div className="p-6 pt-0 bg-gray-50 text-gray-600 leading-relaxed pl-14">
