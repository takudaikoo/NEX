        ...
        <section className="relative z-10 py-24 px-6 md:px-12 bg-gray-50 text-gray-900">
            <div className="max-w-6xl mx-auto">
                <div className="grid md:grid-cols-2 gap-12 lg:gap-24">
                    ...
                    {/* Session Content */}
                    <div>
                        <h2 className="text-2xl font-bold text-gray-900 mb-8 border-l-4 border-impact-red pl-4">
                            初回体験セッションで行うこと
                        </h2>
                        ...
                        <div className="mt-8 p-4 bg-white border border-gray-200 rounded-lg flex items-start gap-3 shadow-sm">
                            <Info size={20} className="text-gray-400 mt-1 flex-shrink-0" />
                    ...
                    <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-xl">
                        ...
                        <ul className="space-y-6">
                            {benefits.map((benefit, index) => (
                                <li key={index} className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
                                    <div className="text-impact-red mt-1">
                                        <Check size={20} />
                                    </div>
                                    <span className="text-gray-800 font-bold leading-relaxed">{benefit}</span>
                                </li>
                            ))}
                        </ul>
                    </div>
