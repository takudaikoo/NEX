...
import { Monitor, Zap, Droplets } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-black text-white flex flex-col md:flex-row overflow-hidden relative font-sans">
            <div className="absolute top-0 left-0 w-full p-6 z-50 flex justify-between items-center pointer-events-none">
                ...
                <div className="text-xs text-gray-500 hidden md:block">インターフェースプロトコル選択</div>
            </div>
            ...
            >
                <div className="absolute inset-0 bg-gradient-to-br from-flow-deep to-flow-blue opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
