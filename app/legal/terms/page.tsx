    ...
    return (
        <div className="min-h-screen bg-black text-white font-noto-sans selection:bg-tech-cyan selection:text-black flex flex-col">
            ...
            <main className="flex-grow container mx-auto px-6 py-20 max-w-4xl">
                <h1 className="text-3xl md:text-4xl font-bold mb-16 tracking-wide border-l-4 border-tech-cyan pl-6">利用規約</h1>

                <div className="space-y-12 text-white/80 leading-relaxed">
                    <p>
                        この利用規約（以下，「本規約」といいます。）は，株式会社NXS（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
                    </p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">第3条（ユーザーIDおよびパスワードの管理）</h2>
                        <ol className="list-decimal pl-6 space-y-2">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">第6条（利用制限および登録抹消）</h2>
                        <ol className="list-decimal pl-6 space-y-2">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">第7条（退会）</h2>
                        <p>ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。</p>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">第8条（保証の否認および免責事項）</h2>
                        <ol className="list-decimal pl-6 space-y-2">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">第9条（サービス内容の変更等）</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">第11条（個人情報の取扱い）</h2>
                        <p>当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">第12条（通知または連絡）</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">第13条（権利義務の譲渡の禁止）</h2>
                        <p>ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-white mb-4">第14条（準拠法・裁判管轄）</h2>
                        <ol className="list-decimal pl-6 space-y-2">
                    ...
                    <div className="text-right mt-12 text-sm text-white/60">
                        以上
                    </div>
                </div>
            </main>
