...
export const metadata = {
    title: '特定商取引法に基づく表記 | Impact Analysis',
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900 font-noto-sans selection:bg-impact-red selection:text-white">
            ...
            <main className="container mx-auto px-6 max-w-4xl pb-24">
                <h1 className="text-3xl md:text-4xl font-bold mb-12 text-gray-900">特定商取引法に基づく表記</h1>
                ...
                <div className="space-y-8">
                    ...
                    <div className="border-b border-gray-200 pb-8 grid md:grid-cols-[200px_1fr] gap-4">
                        <div className="font-bold text-gray-500">代表責任者</div>
                        <div>小尾 拓大</div>
                    </div>
                    ...
                    <div className="border-b border-gray-200 pb-8 grid md:grid-cols-[200px_1fr] gap-4">
                        <div className="font-bold text-gray-500">電話番号</div>
                        <div>
                            090-2031-3841<br />
                            <span className="text-sm text-gray-400">※お問い合わせはメールにてお願い致します。</span>
                        </div>
                    </div>

                    <div className="border-b border-gray-200 pb-8 grid md:grid-cols-[200px_1fr] gap-4">
                        <div className="font-bold text-gray-500">メールアドレス</div>
                    ...
                    <div className="border-b border-gray-200 pb-8 grid md:grid-cols-[200px_1fr] gap-4">
                        <div className="font-bold text-gray-500">お支払い方法</div>
                        <div>クレジットカード決済、銀行振込</div>
                    </div>

                    <div className="border-b border-gray-200 pb-8 grid md:grid-cols-[200px_1fr] gap-4">
                        <div className="font-bold text-gray-500">お支払い時期</div>
                        <div>
                    ...
                    <div className="border-b border-gray-200 pb-8 grid md:grid-cols-[200px_1fr] gap-4">
                        <div className="font-bold text-gray-500">商品のお渡し時期</div>
                        <div>
